                    ...
                    <?php
                        ...
                        foreach($tweet_ar as $value) {
                            ...
                            echo '<li class="list-group-item list-group-item-dark">
                                  ...
                                  <form class="inline-form" action="project_php.php?id=2" method="post"><button class="btn btn-dark" id="rt_btn" name="rt_submit"><i class="fas fa-retweet"></i></button></form>
